# LOC-F001 · Effective Locale Resolution Policy

> **这是一份 WorkPackage 交接文件，不是总账。** 只装 LOC-F001 自己那一份。
...
**目标**：实现 LOC-F001 —— Effective Locale Resolution Policy。
...
判据是 `docs/_check_delivery.py --reports <那个目录> --wp LOC-F001`：
...
### Backend/API/Service｜Applicable · LOC-F001 Owner
