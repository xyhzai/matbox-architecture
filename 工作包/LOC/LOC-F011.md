# LOC-F011 · Google Translation Provider Adapter

> **这是一份 WorkPackage 交接文件，不是总账。** 只装 LOC-F011 自己那一份。
...
**目标**：实现 LOC-F011 —— Google Translation Provider Adapter。
...
判据是 `docs/_check_delivery.py --reports <那个目录> --wp LOC-F011`：
...
### Backend/API/Service｜Applicable · LOC-F011 Owner
