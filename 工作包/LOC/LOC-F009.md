# LOC-F009 · Translation Gateway & Provider Router

> **这是一份 WorkPackage 交接文件，不是总账。** 只装 LOC-F009 自己那一份。
...
**目标**：实现 LOC-F009 —— Translation Gateway & Provider Router。
...
判据是 `docs/_check_delivery.py --reports <那个目录> --wp LOC-F009`：
...
### Backend/API/Service｜Applicable · LOC-F009 Owner
...
| POST | `/loc/translations/batch` | batch_ref |
