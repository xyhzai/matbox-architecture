# LOC-F004 · Next.js / next-intl Web Adapter

> **这是一份 WorkPackage 交接文件，不是总账。** 只装 LOC-F004 自己那一份。
...
**目标**：实现 LOC-F004 —— Next.js / next-intl Web Adapter。
...
判据是 `docs/_check_delivery.py --reports <那个目录> --wp LOC-F004`：
...
### Frontend/UI｜Applicable · next-intl / uni-app 适配层

### Backend/API/Service｜Applicable · LOC-F004 Owner
