# LOC-F013 · Locale Formatting / ICU-CLDR

> **这是一份 WorkPackage 交接文件，不是总账。** 只装 LOC-F013 自己那一份。
...
**目标**：实现 LOC-F013 —— Locale Formatting / ICU-CLDR。
...
判据是 `docs/_check_delivery.py --reports <那个目录> --wp LOC-F013`：
...
### Backend/API/Service｜Applicable · LOC-F013 Owner
