# LOC-F005 · uni-app / Vue I18n Adapter

> **这是一份 WorkPackage 交接文件，不是总账。** 只装 LOC-F005 自己那一份。
...
**目标**：实现 LOC-F005 —— uni-app / Vue I18n Adapter。
...
判据是 `docs/_check_delivery.py --reports <那个目录> --wp LOC-F005`：
...
### Backend/API/Service｜Applicable · LOC-F005 Owner
