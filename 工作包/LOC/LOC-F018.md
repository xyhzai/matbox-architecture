# LOC-F018 · AI Employee Language Intelligence Policy

> **这是一份 WorkPackage 交接文件，不是总账。** 只装 LOC-F018 自己那一份。
...
**目标**：实现 LOC-F018 —— AI Employee Language Intelligence Policy。
...
判据是 `docs/_check_delivery.py --reports <那个目录> --wp LOC-F018`：
...
### Backend/API/Service｜Applicable · LOC-F018 Owner
