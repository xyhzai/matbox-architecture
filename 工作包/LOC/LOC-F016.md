# LOC-F016 · Observability / Cost / Audit / Secret Integration

> **这是一份 WorkPackage 交接文件，不是总账。** 只装 LOC-F016 自己那一份。
...
**目标**：实现 LOC-F016 —— Observability / Cost / Audit / Secret Integration。
...
判据是 `docs/_check_delivery.py --reports <那个目录> --wp LOC-F016`：
...
### Backend/API/Service｜Applicable · LOC-F016 Owner
...
```java
@Test
@Tag("AC-LOC-013")                    // 方便单独跑：mvn test -Dgroups=AC-LOC-013
void locT013_describeWhatThisCriterionVerifies() {   // ← 后半段换成「这条在验什么」，英文小驼峰
