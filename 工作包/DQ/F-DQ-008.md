...
生成于 2026-09-11 06:14（仓库 c4baab5）· 由 `python docs/_build_workpackages.py` 生成，不要手改
...
# ✅ wp/dq-contracts 已经做完并合进 main（2d280073b1da，PR felixapex/matbox#1）
#    shared/contracts 下 8 个契约类已在 main 上并冻结。
#    直接从下面 §0.7 那个基线切你自己的分支就行，不用再等。
